...
(setq user-full-name "Tadhg O'Brien"
      user-mail-address "tigger04@gmail.com")
...
(setq doom-font (font-spec :family "menlo" :size 15 :weight 'regular)
      doom-variable-pitch-font (font-spec :family "applause" :size 13))
...
;; Stop emacs hanging when saving .gpg files
